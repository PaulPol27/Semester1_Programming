//Визначити тип для представлення працівника(прізвище, посада, стаж роботи на посаді).Прізвища і посади можуть повторюватися.В класі крім необхідних методів визначити конструктор за замовченням та конструктор копіювання, функції введення та виведення.Дані містяться у файлі.Створити масив працівників.
//1.	Посортувати його за прізвищем.Вивести дані про кожного працівника у форматі : прізвище – сумарний стаж – перелік посад, які займав цей працівник.
//2.	Знайти працівника з мінімальним стажем на вказаній посаді.
//3.	Змоделювати процес звільнення працівників(вилучити з масиву вказаних працівників)
